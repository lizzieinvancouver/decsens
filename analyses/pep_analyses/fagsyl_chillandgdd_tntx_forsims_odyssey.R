...
write.csv(pre, file="/n/wolkovich_lab/Lab/Cat/prefagsylten.csv", row.names=FALSE)
}
...
write.csv(post, file="/n/wolkovich_lab/Lab/Cat/postfagsylten.csv", row.names=FALSE)
