...
mean2spp.forpaper20yr.sm$species <- gsub("Betula", paste0("Betula pendula"), mean2spp.forpaper20yr.sm$species)
mean2spp.forpaper20yr.sm$species <- gsub("Fagus", paste0("Fagus sylvatica"), mean2spp.forpaper20yr.sm$species)
