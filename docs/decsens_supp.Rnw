...
\vspace{-3ex}
\begin{center}
\captionof{table}{Number of sites for each species used in the study (\\emph{Betula pendula} and \\emph{Fagus sylvatica}) using the PEP725 over 10 and 20-year windows.} \label{tab:bbspp}
