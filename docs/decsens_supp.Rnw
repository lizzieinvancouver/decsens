...
@ % ,  % =c('l', 'p{1.5in}', rep('c',8)) % align=c("p{0.1\\textwidth}|", "p{0.2\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|", "p{0.1\\textwidth}|")
