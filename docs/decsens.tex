...
\begin{figure}[h!]
\centering
\noindent \includegraphics[width=1\textwidth]{..//analyses/figures/ospreeforcems.pdf}
...
\caption{\textbf{Estimates of temperature sensitivities (response per $^{\circ}$C) using linear models and non-linear from long-term harvest data.} Data from \citet{cookwine2016}} 
