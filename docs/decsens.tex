...
\end{abstract}
% (Option a) Climate change accelerates biological time, and thus reshapes relationships with calendar time that may have held for centuries before. 
% (Option b) By accelerating biological time, climate change challenges models based on calendar time to infer mechanism from measurements today. 
% (Option c) As climate change accelerates biological time, models based on calendar time may continue to document shifting sensitivities without any major shift in underlying biology. 
