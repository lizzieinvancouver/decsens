...
% (Option c) As climate change accelerates biological time, models based on calendar time may document shifting sensitivities without any major shift in underlying biology. 
